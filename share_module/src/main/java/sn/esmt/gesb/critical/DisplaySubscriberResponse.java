...
@XmlType(name = "", propOrder = {
    ...
    "callBalance",
    "smsBalance"
}, namespace = "http://esmt.sn/in_api/soam")
@XmlRootElement(name = "displaySubscriberResponse", namespace = "http://esmt.sn/in_api/soam")
public class DisplaySubscriberResponse {

    @XmlElement(required = true, namespace = "http://esmt.sn/in_api/soam")
    public String subscriberName;
    @XmlElement(required = true, namespace = "http://esmt.sn/in_api/soam")
    public String phoneNumber;
    @XmlElement(required = true, namespace = "http://esmt.sn/in_api/soam")
    public String imsi;
    @XmlElement(namespace = "http://esmt.sn/in_api/soam")
