...
CREATE TABLE `constant_config` (
                                   ...
                                   `value_content` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
                                   `wsdl_doc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
...
CREATE TABLE `tpodata` (
                           ...
                           `tpo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
                           `tpo_condition` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
                           `verb` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
                           `list_node_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tpodata` (`id`, `description`, `is_critical`, `tpo`, `tpo_condition`, `verb`, `list_node_id`) VALUES
                                                                                                               ...
                                                                                                               (6, 'This TPO is used to add new service to subscriber', b'0', 'TPO_ADD_SUBS_SERVICE', 'PRE_PAID', 'ADD_SUBS_SERVOCE', 14);
...
CREATE TABLE `tpodata_previous_states_data` (
                                                `tpodata_id` int NOT NULL,
                                                `previous_states_data_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tpowork_order` (
                                 ...
                                 `web_service_class_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
                                 `web_service_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
